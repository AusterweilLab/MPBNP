...
class BiasedGibbs(BaseSampler):
    ...
    def do_inference(self, init_y = None, init_z = None, init_f = None,
                     output_file = None):
...
#            self.samples = h5py.File(output_file)
            
        if self.cl_mode:
            return self._cl_infer_yzf(init_y, init_z, init_f, output_file)
        else:
            return self._infer_yzf(init_y, init_z, init_f, output_file)

    def _infer_yzf(self, init_y, init_z, init_f, output_file):
