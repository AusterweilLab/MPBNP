...
class MPIBPNoisyOrGibbs(MPBaseSampler):
    ...
    def read_csv(self, filepath, header=True):
        ...
        """
        MPBaseSampler.read_csv(self, filepath, header)
    ...
    def direct_read_obs(self, obs):
        MPBaseSampler.read_csv(self, obs)
        self.d = len(self.obs[0])
    ...
    def do_inference(self, init_y = None, init_z = None, output_file = None):
        ...
        """
        MPBaseSampler.do_inference(self, output_file)
        if init_y is None:
    ...
    def _infer_yz(self, init_y, init_z, output_file = None):
        ...
        print(cur_y, file=sys.stderr)
        print(cur_z, file=sys.stderr)
        print(self.lam)
    ...
    def _cl_infer_y(self, cur_y, cur_z, d_obs):
        ...
        # note that it returns d_cur_y and d_cur_z
        return cur_y
...
if __name__ == '__main__':
    ...
    ibp_sampler = MPIBPNoisyOrGibbs(cl_mode = True)
    ibp_sampler.read_csv('ibp-image.csv')
